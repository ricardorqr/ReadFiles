...
if __name__ == '__main__':
    ...
    with open('C:/Users/ricar/Desktop/Output Trending Songs.csv', 'w', encoding='UTF8') as file:
    ...
    plt.title(query + ' -> ' + str("{:,}".format(len(songs))) + ' Trending Songs')
    plt.show()
